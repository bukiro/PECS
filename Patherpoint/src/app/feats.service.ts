        ...
        if (feats.length) {
            ...
            if (feat.increase) {
                if (taken) {
                    ...
                    let newSkillChoice = character.add_SkillChoice(level, {available:0, increases:[], type:"Any", maxRank:2, source:'Feat: '+featName, id:0});
            ...
            if (feat.gainAncestryFeat) {
                if (taken) {
                    character.add_FeatChoice(level, {available:1, feats:[], type:"Ancestry", source:'Feat: '+featName, id:0});
                } else {
            ...
            if (feat.gainGeneralFeat) {
                if (taken) {
                    character.add_FeatChoice(level, {available:1, feats:[], type:"General", source:'Feat: '+featName, id:0});
                } else {
                    let a = level.featChoices;
            ...
            if (feat.gainClassFeat) {
                if (taken) {
                    character.add_FeatChoice(level, {available:1, feats:[], type:"Class", source:'Feat: '+featName, id:0});
                } else {
                    let a = level.featChoices;
            ...
            if (feat.gainSkillTraining) {
                if (taken) {
                    character.add_SkillChoice(level, {available:1, increases:[], type:"Skill", maxRank:2, source:'Feat: '+featName, id:0});
                } else {
                    let a = level.skillChoices;
            ...
            if (feat.gainLore) {
                if (taken) {
                    character.add_LoreChoice(level, {available:1, increases:[], loreName:"", loreDesc:"", source:'Feat: '+featName, id:0});
                } else {
