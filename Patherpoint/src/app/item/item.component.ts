    ...
    on_SpellItemUse(item: Item) {
        ...
        if (spellChoice && spellName) {
            ...
            if (spell) {
                ...
                this.spellsService.process_Spell(this.get_Creature("Character"), target, this.characterService, this.itemsService, this.characterService.timeService, null, tempGain, spell, spellChoice.level, true, true, false);
            }
