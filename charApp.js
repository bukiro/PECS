...
app.controller('charCtrl', function($scope,$filter) {
  ...
  $scope.traits = [
    ...
    { name:'Brutal', showon:'', desc:'A ranged attack with this trait uses its Strength modifier instead of Dexterity on the attack roll.', have:function() { return $scope.traits.have(this) }, attack:function() {return $scope.abilities.byName("Strength").mod();}, },
    ...
    { name:'Finesse', showon:'', desc:'You can use your Dexterity modifier instead of your Strength modifier on attack rolls using this melee weapon. You still use your Strength modifier when calculating damage.', have:function() { return $scope.traits.have(this) }, attack:function() {if ($scope.abilities.byName("Dexterity").mod() > $scope.abilities.byName("Strength").mod()) {return $scope.abilities.byName("Dexterity").mod();}}, },
