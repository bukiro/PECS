...
export class Spell {
    ...
    get_HeightenedConditions(levelNumber: number = this.levelreq) {
        ...
        if (!this.gainConditions.length || !this.gainConditions.find(gain => gain.heightenedFilter)) {
            ...
            switch (levelNumber) {
                case 10:
                    if (this.gainConditions.some(gain => gain.heightenedFilter == 10)) {
                        return this.gainConditions.filter(gain => !gain.heightenedFilter || gain.heightenedFilter == 10);
                    }
                //If nothing is found, fall through to the next highest level.
                case 9:
                    if (this.gainConditions.some(gain => gain.heightenedFilter == 9)) {
                        return this.gainConditions.filter(gain => !gain.heightenedFilter || gain.heightenedFilter == 9);
                    }
                //If nothing is found, fall through to the next highest level.
                case 8:
                    if (this.gainConditions.some(gain => gain.heightenedFilter == 8)) {
                        return this.gainConditions.filter(gain => !gain.heightenedFilter || gain.heightenedFilter == 8);
                    }
                //If nothing is found, fall through to the next highest level.
                case 7:
                    if (this.gainConditions.some(gain => gain.heightenedFilter == 7)) {
                        return this.gainConditions.filter(gain => !gain.heightenedFilter || gain.heightenedFilter == 7);
                    }
                //If nothing is found, fall through to the next highest level.
                case 6:
                    if (this.gainConditions.some(gain => gain.heightenedFilter == 6)) {
                        return this.gainConditions.filter(gain => !gain.heightenedFilter || gain.heightenedFilter == 6);
                    }
                //If nothing is found, fall through to the next highest level.
                case 5:
                    if (this.gainConditions.some(gain => gain.heightenedFilter == 5)) {
                        return this.gainConditions.filter(gain => !gain.heightenedFilter || gain.heightenedFilter == 5);
                    }
                //If nothing is found, fall through to the next highest level.
                case 4:
                    if (this.gainConditions.some(gain => gain.heightenedFilter == 4)) {
                        return this.gainConditions.filter(gain => !gain.heightenedFilter || gain.heightenedFilter == 4);
                    }
                //If nothing is found, fall through to the next highest level.
                case 3:
                    if (this.gainConditions.some(gain => gain.heightenedFilter == 3)) {
                        return this.gainConditions.filter(gain => !gain.heightenedFilter || gain.heightenedFilter == 3);
                    }
                //If nothing is found, fall through to the next highest level.
                case 2:
                    if (this.gainConditions.some(gain => gain.heightenedFilter == 2)) {
                        return this.gainConditions.filter(gain => !gain.heightenedFilter || gain.heightenedFilter == 2);
                    }
                //If nothing is found, fall through to the next highest level.
                case 1:
                    if (this.gainConditions.some(gain => gain.heightenedFilter == 1)) {
                        return this.gainConditions.filter(gain => !gain.heightenedFilter || gain.heightenedFilter == 1);
                    }
                //If nothing is found, fall through to the next highest level.
                default:
