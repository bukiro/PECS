...
app.controller('charCtrl', function($scope,$filter) {
  ...
  class Feat {
    constructor(
      ...
      public weaponreq: string = "",
      public armorreq: string = "",
  ...
  $scope.itemget = function(item) {
    ...
    switch(item.constructor.name) {
      case "Weapon": { newitem = new Weapon(); break;}
      case "Armor": { newitem = new Armor(); break;}
      case "Shield": { newitem = new Shield(); break;}
    }
