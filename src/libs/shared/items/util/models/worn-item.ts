...
import { MessageSerializable, MaybeSerialized, Serialized } from 'src/libs/shared/serialization/util/models/serializable';
import { setupSerializationWithHelpers } from 'src/libs/shared/serialization/util/utils/serialization';
import { MaxSpellLevel } from 'src/libs/shared/spells/util/models/spell-levels';
...
export class WornItem extends Equipment implements MessageSerializable<WornItem> {
    ...
    public with(values: MaybeSerialized<WornItem>, recastFns: RecastFns): this {
    ...
    public clone(recastFns: RecastFns): this {
        return WornItem.from(this, recastFns) as this;
    }
