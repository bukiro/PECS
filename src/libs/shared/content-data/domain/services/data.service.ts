...
import { ImportedJsonFileList } from '../../util/models/imported-json-file-list';
...
export class DataService {
    ...
    private _initialize(): void {
        this._statusStore.setDataStatus({ key: ApiStatusKey.Initializing, message: 'Loading extensions...' });
        ...
        zip([
            ...
            .subscribe(() => {
                this._statusStore.setDataStatus({ key: ApiStatusKey.Ready });
            });
    }
