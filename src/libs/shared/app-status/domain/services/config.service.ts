...
import { parseVersion, isAvailableVersionNewer } from '../../util/utils/version-utils';
...
export class ConfigService {
    ...
    public updateVersionAvailable = signal<string>('');
    ...
    constructor() {
        ...
        this.isReady = computed(() => this._statusStore.config().key === ApiStatusKey.Ready);
            ...
            .pipe(
                ...
                catchError(error => {
                    if (error.status === HttpStatusCode.NotFound) {
                        ...
                        this._statusStore.setConfigStatus({
                ...
                map((data: object | undefined) => {
                    ...
                    this._statusStore.setConfigStatus({ key: ApiStatusKey.Ready });
