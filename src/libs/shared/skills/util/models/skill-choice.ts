...
import { maxSkillLevel } from './skill-levels';
...
export class SkillChoice implements Serializable<SkillChoice> {
    ...
    public clone(): this {
        return SkillChoice.from(this) as this;
    }
