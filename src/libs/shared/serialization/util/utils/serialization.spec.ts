...
import { MessageSerializable, MaybeSerialized, Serialized } from '../models/serializable';
...
class SerializationTestClass implements MessageSerializable<SerializationTestClass> {
    ...
    public with(values: MaybeSerialized<SerializationTestClass>): this {
        assign(this, values);
    ...
    public clone(): this {
        return SerializationTestClass.from(this) as this;
    }
