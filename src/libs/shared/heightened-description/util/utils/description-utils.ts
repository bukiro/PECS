import { HeightenedDescriptionVariable } from '../models/heightened-description-variable';
import { HeightenedDescriptionVariableCollection } from '../models/heightened-description-variable-collection';
...
export function heightenedTextFromDescSets(text: string, levelNumber: number, descSets: Array<HeightenedDescriptionVariableCollection>): string {
    // For an arbitrary text (usually a spell or condition description),
