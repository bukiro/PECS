...
import { SystemColors } from '../../util/models/system-colors';
import { BonusListComponent } from 'src/libs/shared/bonuses/ui/bonus-list/bonus-list.component';
...
export class PrettyValueComponent {
    ...
    public readonly large$$ = input(false, { alias: 'large', transform: booleanAttribute });

    public readonly secondary$$ = input(false, { alias: 'secondary', transform: booleanAttribute });
    ...
    public readonly forceAbsolute$$ = input(false, { alias: 'forceAbsolute', transform: booleanAttribute });
    public readonly forceBonus$$ = input(false, { alias: 'forceBonus', transform: booleanAttribute });
    public readonly forcePenalty$$ = input(false, { alias: 'forcePenalty', transform: booleanAttribute });

    public readonly opaque$$ = input(false, { alias: 'opaque', transform: booleanAttribute });
