...
import { EmblazonArmamentTypes } from '../../../../libs/shared/feats/util/models/emblazon-armament-types';
import { EmblazonArmamentSet } from '../../../../libs/shared/items/util/models/emblazon-armament-set';
import { Feat } from '../../../../libs/shared/feats/util/models/feat';
import { HintShowingItem } from '../../definitions/types/hint-showing-item';
import { emptySafeCombineLatest, propMap$ } from '../../../../libs/shared/common/util/utils/observable-utils';
...
import { CreatureActivitiesService } from '../../../../libs/shared/activities/domain/services/creature-activities.service';
import { CreatureFeatsService } from '../../../../libs/shared/feats/domain/services/creature-feats.service';
...
export class HintShowingObjectsService {
    ...
    Observable<Array<AnimalCompanionAncestry | AnimalCompanionSpecialization | Feat>> {
        ...
        return combineLatest([
            propMap$(CreatureService.animalCompanion$$, 'class$', 'ancestry$'),
            propMap$(CreatureService.animalCompanion$$, 'class$', 'specializations', 'values$'),
    ...
    public creatureConditionsShowingHintsOnThis$(creature: Creature, objectName = 'all'): Observable<Array<ConditionGainSet>> {
        ...
        return this._appliedCreatureConditionsService.appliedConditions$$(creature)
            .pipe(
                map(conditions =>
                    conditions
                        .filter(({ condition }) =>
