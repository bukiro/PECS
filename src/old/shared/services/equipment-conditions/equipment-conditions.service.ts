...
import { propMap$ } from '../../../../libs/shared/common/util/utils/observable-utils';
...
import { CreatureAvailabilityService } from '../../../../libs/shared/creatures/domain/services/creature-availability.service';
import { CreatureConditionsService } from '../../../../libs/shared/conditions/domain/services/creature-conditions.service';
import { CreatureService } from '../../../../libs/shared/creatures/domain/services/creature.service';
import { EvaluationService } from '../../../../libs/shared/value-formulas/domain/services/evaluation.service';
...
import { SettingsService } from '../../../../libs/shared/app-status/domain/services/settings.service';
import { CreatureConditionRemovalService } from '../../../../libs/shared/conditions/domain/services/creature-condition-removal.service';
import { CreatureConditionsAdapter } from '../../../../libs/shared/conditions/util/utils/creature-conditions-adapter';
...
export class EquipmentConditionsService {
    ...
    constructor(
        ...
        private readonly _appliedCreatureConditionsService: CreatureConditionsAdapter,
                ...
                switchMap(isManualMode =>
                    ...
                    isManualMode
                        ...
                        : combineLatest([
                            ...
                            this._appliedCreatureConditionsService.appliedConditions$$(
                                creature,
