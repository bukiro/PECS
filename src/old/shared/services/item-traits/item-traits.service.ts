...
import { safeParseInt, stringEqualsCaseInsensitive } from '../../../../libs/shared/common/util/utils/string-utils';
import { isEqualPrimitiveArray } from '../../../../libs/shared/common/util/utils/compare-utils';
...
export class ItemTraitsService {
    ...
    private _armorEffectiveTraits$$(armor: Armor): Signal<Array<string>> {
        return computed(() => {
            const armoredSkirtFactor = armor.effectiveArmoredSkirtModifier$$();
