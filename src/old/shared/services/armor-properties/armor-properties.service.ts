...
import { ShoddyPenalties } from '../../../../libs/shared/items/util/models/shoddy-penalties';
import { maxSkillLevel } from '../../../../libs/shared/skills/util/models/skill-levels';
...
export class ArmorPropertiesService {
    ...
    public effectiveProficiency$(armor: Armor, context: { creature: Creature }): Observable<string> {
        return this._appliedCreatureConditionsService.appliedConditions$$(context.creature, { name: 'Mage Armor' })
            .pipe(
