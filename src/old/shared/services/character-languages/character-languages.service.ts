...
import { FeatGain } from '../../../../libs/shared/feats/util/models/feat-gain';
...
import { abilityModFromAbilityValue } from '../../../../libs/shared/abilities/util/utils/ability-base-value-utils';
import { propMap$, emptySafeCombineLatest } from '../../../../libs/shared/common/util/utils/observable-utils';
...
import { isEqualObjectArray, isEqualPrimitiveObject } from '../../../../libs/shared/common/util/utils/compare-utils';
...
export class CharacterLanguagesService {
    ...
    private _extractLanguageEffectsFromFeatSet(
        featTaken: { levelNumber: number; gain: FeatGain },
        character: Character,
