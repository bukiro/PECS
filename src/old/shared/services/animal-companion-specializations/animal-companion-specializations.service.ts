...
import { Serialized } from '../../../../libs/shared/serialization/util/models/serializable';
...
export class AnimalCompanionSpecializationsService {
    ...
    // TODO: Expand the serialization system to better compare and reduce these objects.
