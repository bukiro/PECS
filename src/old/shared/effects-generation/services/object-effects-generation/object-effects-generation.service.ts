                                            ...
                                            this._determineEffectTitle$(effectGain, { value, setValue }, { ...context, source }, options)
                                                .pipe(
                                                    map(effectTitle => {
                                                        ...
                                                        const isFromEvolution = (
                                                            object instanceof Feat || object instanceof AnimalCompanionSpecialization
                                                        );

                                                        if (shouldShowEffect !== true && isFromEvolution) {
