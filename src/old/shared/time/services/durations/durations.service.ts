...
import { TurnService } from '../../../../../libs/shared/time/domain/services/turn.service';
...
export class DurationsService {
    ...
    public durationDescription$(duration: number, includeTurnState = true, inASentence = false, short = false): Observable<string> {
            ...
            .pipe(
                map(yourTurn => {
                    ...
                    if (workingDuration === TimePeriods.HalfTurn) {
                        ...
                        if (yourTurn === TimePeriods.NoTurn) {
                            return inASentence
                    ...
                    if (includeTurnState && workingDuration === TimePeriods.HalfTurn && yourTurn === TimePeriods.HalfTurn) {
                        returnString += ' to end of turn';
                    }

                    if (includeTurnState && workingDuration === TimePeriods.HalfTurn && yourTurn === TimePeriods.NoTurn) {
